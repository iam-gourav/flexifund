...
function FaqPage() {
    return (
        <div className='pt-20'>
            <h2 className='text-center text-4xl font-bold py-10 text-green-500'>FAQS</h2>
            <p className='text-center text-2xl font-bold py-5 text-gray-500'>Frequently Asked Questions</p>
            <div className="m-2 space-y-2">
                <div
                    className="group flex flex-col gap-2 border-2 border-b-green-500 rounded-lg bg-white p-5 text-black"
                    tabindex="1"
                >
